...
///
/// `HyperAD_ADFN<N>` stores a value and its `N` associated tangents. This allows for computing
/// up to `N` columns of a Jacobian simultaneously in a single forward pass.
#[allow(non_camel_case_types)]
#[cfg_attr(feature = "bevy", derive(Reflect))]
#[derive(Clone, Debug, Copy)]
pub struct HyperAD_ADFN<const N: usize> {
    /// The primary value.
    pub(crate) value: crate::forward_ad::adfn::adfn<N>,
    /// The tangent values corresponding to the derivatives with respect to input variables.
    pub(crate) tangent: [crate::forward_ad::adfn::adfn<N>; N],
}
impl<const N: usize> HyperAD_ADFN<N> {
    /// Creates a new `HyperAD_ADFN` value with its associated tangents.
    pub fn new(value: crate::forward_ad::adfn::adfn<N>, tangent: [crate::forward_ad::adfn::adfn<N>; N]) -> Self {
        Self { value, tangent }
    }
    
    /// Creates a new `HyperAD_ADFN` directly from an inner type.
    pub fn new_inner_constant(value: crate::forward_ad::adfn::adfn<N>) -> Self {
        Self {
            value,
            tangent: core::array::from_fn(|_| crate::forward_ad::adfn::adfn::constant(0.0)),
        }
    }
    
    /// Gets the inner primary value.
    #[inline]
    pub fn inner_value(&self) -> crate::forward_ad::adfn::adfn<N> {
        self.value
    }
    
    /// Gets the inner tangents.
    #[inline]
    pub fn inner_tangent(&self) -> [crate::forward_ad::adfn::adfn<N>; N] {
        self.tangent
    }
    
    /// Creates a new constant `HyperAD_ADFN` value (all tangents are zero).
    pub fn new_constant(value: f64) -> Self {
        Self {
            value: crate::forward_ad::adfn::adfn::constant(value),
            tangent: core::array::from_fn(|_| crate::forward_ad::adfn::adfn::constant(0.0)),
        }
    }
    #[inline]
    ...
    #[inline]
    pub fn tangent(&self) -> [crate::forward_ad::adfn::adfn<N>; N] {
        self.tangent
    }
    #[inline]
...
impl<const N: usize> AD for HyperAD_ADFN<N> {
    fn constant(constant: f64) -> Self {
        Self {
            value: crate::forward_ad::adfn::adfn::constant(constant),
            tangent: core::array::from_fn(|_| crate::forward_ad::adfn::adfn::constant(0.0)),
        }
    }
...
impl<const N: usize> ScalarOperand for HyperAD_ADFN<N> {}

impl<const N: usize> ForwardADTrait for HyperAD_ADFN<N> {
    fn value(&self) -> f64 {
        self.value.value()
    }
    ...
    fn set_value(&mut self, value: f64) {
        self.value = crate::forward_ad::adfn::adfn::constant(value);
    }

    fn set_tangent_value(&mut self, idx: usize, value: f64) {
        self.tangent[idx] = crate::forward_ad::adfn::adfn::constant(value);
    }
}

impl<const N: usize> Default for HyperAD_ADFN<N> {
    fn default() -> Self {
        Self::constant(0.0)
    }
}
...
/*
impl<const N: usize, R: Clone + Dim, C: Clone + Dim, S: Clone + RawStorageMut<Self, R, C>> NalgebraMatMulAD2<R, C, S> for HyperAD_ADFN<N> {
...
fn two_vecs_mul_and_add<const N: usize>(
    vec1: &[crate::forward_ad::adfn::adfn<N>; N],
    vec2: &[crate::forward_ad::adfn::adfn<N>; N],
    scalar1: crate::forward_ad::adfn::adfn<N>,
    scalar2: crate::forward_ad::adfn::adfn<N>,
) -> [crate::forward_ad::adfn::adfn<N>; N] {
    let mut out = core::array::from_fn(|_| crate::forward_ad::adfn::adfn::constant(0.0));
    for i in 0..N {
...
#[inline(always)]
fn mul_with_nan_check<const N: usize>(a: crate::forward_ad::adfn::adfn<N>, b: crate::forward_ad::adfn::adfn<N>) -> crate::forward_ad::adfn::adfn<N> {
    return if a.value.is_nan() && b.value == 0.0 {
        crate::forward_ad::adfn::adfn::constant(0.0)
...
#[inline(always)]
fn two_vecs_add<const N: usize>(vec1: &[crate::forward_ad::adfn::adfn<N>; N], vec2: &[crate::forward_ad::adfn::adfn<N>; N]) -> [crate::forward_ad::adfn::adfn<N>; N] {
    let mut out = core::array::from_fn(|_| crate::forward_ad::adfn::adfn::constant(0.0));
    for i in 0..N {
        out[i] = vec1[i] + vec2[i];
    }
...
#[inline(always)]
fn one_vec_mul<const N: usize>(vec: &[crate::forward_ad::adfn::adfn<N>; N], scalar: crate::forward_ad::adfn::adfn<N>) -> [crate::forward_ad::adfn::adfn<N>; N] {
    let mut out = core::array::from_fn(|_| crate::forward_ad::adfn::adfn::constant(0.0));
    for i in 0..N {
        out[i] = scalar * vec[i];
    }
...
#[inline(always)]
fn one_vec_mul_with_nan_check<const N: usize>(vec: &[crate::forward_ad::adfn::adfn<N>; N], scalar: crate::forward_ad::adfn::adfn<N>) -> [crate::forward_ad::adfn::adfn<N>; N] {
    let mut out = core::array::from_fn(|_| crate::forward_ad::adfn::adfn::constant(0.0));
    for i in 0..N {
...
impl<const N: usize> Add<F64> for HyperAD_ADFN<N> {
    type Output = Self;
...
impl<const N: usize> AddAssign<F64> for HyperAD_ADFN<N> {
    #[inline]
...
impl<const N: usize> Mul<F64> for HyperAD_ADFN<N> {
    type Output = Self;
...
impl<const N: usize> MulAssign<F64> for HyperAD_ADFN<N> {
    #[inline]
...
impl<const N: usize> Sub<F64> for HyperAD_ADFN<N> {
    type Output = Self;
...
impl<const N: usize> SubAssign<F64> for HyperAD_ADFN<N> {
    #[inline]
...
impl<const N: usize> Div<F64> for HyperAD_ADFN<N> {
    type Output = Self;
...
impl<const N: usize> DivAssign<F64> for HyperAD_ADFN<N> {
    #[inline]
...
impl<const N: usize> Rem<F64> for HyperAD_ADFN<N> {
    type Output = Self;
...
impl<const N: usize> RemAssign<F64> for HyperAD_ADFN<N> {
    #[inline]
...
impl<const N: usize> Add<Self> for HyperAD_ADFN<N> {
    type Output = Self;
...
impl<const N: usize> AddAssign<Self> for HyperAD_ADFN<N> {
    #[inline]
...
impl<const N: usize> Mul<Self> for HyperAD_ADFN<N> {
    type Output = Self;
...
impl<const N: usize> MulAssign<Self> for HyperAD_ADFN<N> {
    #[inline]
...
impl<const N: usize> Sub<Self> for HyperAD_ADFN<N> {
    type Output = Self;

    #[inline]
    fn sub(self, rhs: Self) -> Self::Output {
        let output_value = self.value - rhs.value;
        let output_tangent = two_vecs_mul_and_add(&self.tangent, &rhs.tangent, crate::forward_ad::adfn::adfn::constant(1.0), crate::forward_ad::adfn::adfn::constant(-1.0));
...
impl<const N: usize> SubAssign<Self> for HyperAD_ADFN<N> {
    #[inline]
...
impl<const N: usize> Div<Self> for HyperAD_ADFN<N> {
    type Output = Self;

    #[inline]
    fn div(self, rhs: Self) -> Self::Output {
        let output_value = self.value / rhs.value;
        let d_div_d_arg1 = crate::forward_ad::adfn::adfn::constant(1.0) / rhs.value;
        let d_div_d_arg2 = crate::forward_ad::adfn::adfn::constant(-1.0)*self.value / (rhs.value * rhs.value);
        let output_tangent =
...
impl<const N: usize> DivAssign<Self> for HyperAD_ADFN<N> {
    #[inline]
...
impl<const N: usize> Rem<Self> for HyperAD_ADFN<N> {
    type Output = Self;
...
impl<const N: usize> RemAssign<Self> for HyperAD_ADFN<N> {
    #[inline]
...
impl<const N: usize> Neg for HyperAD_ADFN<N> {
    type Output = Self;
    ...
    fn neg(self) -> Self::Output {
        Self {
            value: -self.value,
            tangent: one_vec_mul(&self.tangent, crate::forward_ad::adfn::adfn::constant(-1.0)),
        }
    }
}
...
impl<const N: usize> Float for adf<N> {
    fn nan() -> Self {
        Self::constant(crate::forward_ad::adfn::adfn::constant(f64::NAN))
    }

    fn infinity() -> Self {
        Self::constant(crate::forward_ad::adfn::adfn::constant(f64::INFINITY))
    }

    fn neg_infinity() -> Self {
        Self::constant(crate::forward_ad::adfn::adfn::constant(f64::NEG_INFINITY))
    }
    ...
    fn min_positive_value() -> Self {
        Self::constant(crate::forward_ad::adfn::adfn::constant(f64::MIN)_POSITIVE)
    }
...
impl<const N: usize> PartialEq for HyperAD_ADFN<N> {
    #[inline]
...
impl<const N: usize> PartialOrd for HyperAD_ADFN<N> {
    #[inline]
...
impl<const N: usize> Display for HyperAD_ADFN<N> {
...
impl<const N: usize> From<f64> for HyperAD_ADFN<N> {
    fn from(value: f64) -> Self {
        Self::new(crate::forward_ad::adfn::adfn::constant(value), core::array::from_fn(|_| crate::forward_ad::adfn::adfn::constant(0.0)))
    }
}
impl<const N: usize> Into<f64> for HyperAD_ADFN<N> {
    fn into(self) -> f64 {
        self.value()
    }
}
impl<const N: usize> From<f32> for HyperAD_ADFN<N> {
    fn from(value: f32) -> Self {
        Self::new(crate::forward_ad::adfn::adfn::constant(value as f64), core::array::from_fn(|_| crate::forward_ad::adfn::adfn::constant(0.0)))
    }
}
impl<const N: usize> Into<f32> for HyperAD_ADFN<N> {
    fn into(self) -> f32 {
        self.value() as f32
    }
}
...
impl<const N: usize> UlpsEq for HyperAD_ADFN<N> {
...
impl<const N: usize> AbsDiffEq for HyperAD_ADFN<N> {
    type Epsilon = Self;
...
impl<const N: usize> RelativeEq for HyperAD_ADFN<N> {
...
impl<const N: usize> SimdValue for HyperAD_ADFN<N> {
    const LANES: usize = 4;
    type Element = Self;
    type SimdBool = bool;
...
impl<const N: usize, R: Clone + Dim, C: Clone + Dim, S: Clone + RawStorageMut<HyperAD_ADFN<N>, R, C>>
    Mul<Matrix<HyperAD_ADFN<N>, R, C, S>> for HyperAD_ADFN<N>
{
...
impl<const N: usize, D: DimName> Mul<OPoint<HyperAD_ADFN<N>, D>> for HyperAD_ADFN<N>
where
    DefaultAllocator: nalgebra::allocator::Allocator<HyperAD_ADFN<N>, D>,
    DefaultAllocator: nalgebra::allocator::Allocator<D>,
{
    type Output = OPoint<HyperAD_ADFN<N>, D>;

    fn mul(self, rhs: OPoint<HyperAD_ADFN<N>, D>) -> Self::Output {
        let mut out_clone = rhs.clone();
        for e in out_clone.iter_mut() {
            *e *= self;
        }
...
impl<const N: usize> Zero for HyperAD_ADFN<N> {
    #[inline(always)]
    fn zero() -> Self {
...
impl<const N: usize> One for HyperAD_ADFN<N> {
    #[inline(always)]
    fn one() -> Self {
        Self::constant(1.0)
    }
...
impl<const N: usize> Num for HyperAD_ADFN<N> {
...
impl<const N: usize> Signed for HyperAD_ADFN<N> {
    #[inline]
    fn abs(&self) -> Self {
        ...
        let output_tangent = if self.value.value() >= 0.0 {
            ...
            one_vec_mul(&self.tangent, crate::forward_ad::adfn::adfn::constant(-1.0))
        };
    ...
    fn signum(&self) -> Self {
        ...
        let output_tangent = core::array::from_fn(|_| crate::forward_ad::adfn::adfn::constant(0.0));
        Self {
            value: output_value,
            tangent: output_tangent,
        }
...
impl<const N: usize> FromPrimitive for HyperAD_ADFN<N> {
...
impl<const N: usize> Bounded for HyperAD_ADFN<N> {
    fn min_value() -> Self {
...
impl<const N: usize> RealField for HyperAD_ADFN<N> {
...
impl<const N: usize> ComplexField for HyperAD_ADFN<N> {
    type RealField = Self;
    ...
    #[inline]
    fn floor(self) -> Self {
        Self::new(ComplexField::floor(self.value), core::array::from_fn(|_| crate::forward_ad::adfn::adfn::constant(0.0)))
    }

    #[inline]
    fn ceil(self) -> Self {
        Self::new(ComplexField::ceil(self.value), core::array::from_fn(|_| crate::forward_ad::adfn::adfn::constant(0.0)))
    }

    #[inline]
    fn round(self) -> Self {
        Self::new(ComplexField::round(self.value), core::array::from_fn(|_| crate::forward_ad::adfn::adfn::constant(0.0)))
    }

    #[inline]
    fn trunc(self) -> Self {
        Self::new(ComplexField::trunc(self.value), core::array::from_fn(|_| crate::forward_ad::adfn::adfn::constant(0.0)))
    }

    #[inline]
    fn fract(self) -> Self {
        Self::new(ComplexField::fract(self.value), core::array::from_fn(|_| crate::forward_ad::adfn::adfn::constant(1.0)))
    }
    ...
    fn tan(self) -> Self {
        ...
        let d_tan_d_arg1 = crate::forward_ad::adfn::adfn::constant(1.0) / (c * c);
    ...
    fn asin(self) -> Self {
        ...
        let d_asin_d_arg1 = crate::forward_ad::adfn::adfn::constant(1.0) / (crate::forward_ad::adfn::adfn::constant(1.0) - self.value * self.value).sqrt();
    ...
    fn acos(self) -> Self {
        ...
        let d_acos_d_arg1 = crate::forward_ad::adfn::adfn::constant(-1.0) / (crate::forward_ad::adfn::adfn::constant(1.0) - self.value * self.value).sqrt();
    ...
    fn atan(self) -> Self {
        ...
        let d_atan_d_arg1 = crate::forward_ad::adfn::adfn::constant(1.0) / (self.value * self.value + crate::forward_ad::adfn::adfn::constant(1.0));
    ...
    fn tanh(self) -> Self {
        ...
        let d_tanh_d_arg1 = crate::forward_ad::adfn::adfn::constant(1.0) / (c * c);
    ...
    fn asinh(self) -> Self {
        ...
        let d_asinh_d_arg1 = crate::forward_ad::adfn::adfn::constant(1.0) / (self.value * self.value + crate::forward_ad::adfn::adfn::constant(1.0)).sqrt();
    ...
    fn acosh(self) -> Self {
        ...
        let d_acosh_d_arg1 = crate::forward_ad::adfn::adfn::constant(1.0) / (self.value * self.value - crate::forward_ad::adfn::adfn::constant(1.0)).sqrt();
    ...
    fn atanh(self) -> Self {
        ...
        let d_atanh_d_arg1 = crate::forward_ad::adfn::adfn::constant(1.0) / (crate::forward_ad::adfn::adfn::constant(1.0) - self.value * self.value);
    ...
    fn log(self, base: Self::RealField) -> Self {
        ...
        let d_log_d_arg1 = crate::forward_ad::adfn::adfn::constant(1.0) / (self.value * ln_rhs);
    ...
    fn sqrt(self) -> Self {
        ...
        let tmp = if self.value.value() == 0.0 {
            crate::forward_ad::adfn::adfn::constant(0.0001)
        } else {
            self.value
        };
        let d_sqrt_d_arg1 = crate::forward_ad::adfn::adfn::constant(1.0) / (crate::forward_ad::adfn::adfn::constant(2.0) * tmp.sqrt());
    ...
    fn powf(self, n: Self::RealField) -> Self {
        ...
        let d_powf_d_arg1 = n.value * self.value.powf(n.value - crate::forward_ad::adfn::adfn::constant(1.0));
        let tmp = if self.value.value() == 0.0 {
            crate::forward_ad::adfn::adfn::constant(0.0001)
        } else {
            self.value
...
impl<const N: usize> SubsetOf<Self> for HyperAD_ADFN<N> {
    fn to_superset(&self) -> Self {
        self.clone()
    }

    fn from_superset_unchecked(element: &HyperAD_ADFN<N>) -> Self {
        element.clone()
    }

    fn is_in_subset(_element: &HyperAD_ADFN<N>) -> bool {
        true
    }
}

impl<const N: usize> Field for HyperAD_ADFN<N> {}

impl<const N: usize> PrimitiveSimdValue for HyperAD_ADFN<N> {}

impl<const N: usize> SubsetOf<HyperAD_ADFN<N>> for f32 {
    fn to_superset(&self) -> HyperAD_ADFN<N> {
        HyperAD_ADFN::<N>::new_constant(*self as f64)
    }
    ...
    fn is_in_subset(_: &HyperAD_ADFN<N>) -> bool {
        false
    }
}

impl<const N: usize> SubsetOf<HyperAD_ADFN<N>> for f64 {
    fn to_superset(&self) -> HyperAD_ADFN<N> {
        HyperAD_ADFN::<N>::new_constant(*self as f64)
    }
...
impl<const N: usize> SubsetOf<HyperAD_ADFN<N>> for u32 {
    fn to_superset(&self) -> HyperAD_ADFN<N> {
        HyperAD_ADFN::<N>::new_constant(*self as f64)
    }
...
impl<const N: usize> SubsetOf<HyperAD_ADFN<N>> for u64 {
    fn to_superset(&self) -> HyperAD_ADFN<N> {
        HyperAD_ADFN::<N>::new_constant(*self as f64)
    }
...
impl<const N: usize> SubsetOf<HyperAD_ADFN<N>> for u128 {
    fn to_superset(&self) -> HyperAD_ADFN<N> {
        HyperAD_ADFN::<N>::new_constant(*self as f64)
    }
...
impl<const N: usize> SubsetOf<HyperAD_ADFN<N>> for i32 {
    fn to_superset(&self) -> HyperAD_ADFN<N> {
        HyperAD_ADFN::<N>::new_constant(*self as f64)
    }
...
impl<const N: usize> SubsetOf<HyperAD_ADFN<N>> for i64 {
    fn to_superset(&self) -> HyperAD_ADFN<N> {
        HyperAD_ADFN::<N>::new_constant(*self as f64)
    }
...
impl<const N: usize> SubsetOf<HyperAD_ADFN<N>> for i128 {
    fn to_superset(&self) -> HyperAD_ADFN<N> {
        HyperAD_ADFN::<N>::new_constant(*self as f64)
    }
...
unsafe impl<const N: usize> Dim for HyperAD_ADFN<N> {
...
impl<const N: usize> Serialize for HyperAD_ADFN<N> {
    fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error> where S: Serializer {
        serializer.serialize_none()
    }
}
impl<'de, const N: usize> Deserialize<'de> for HyperAD_ADFN<N> {
    fn deserialize<D>(_deserializer: D) -> Result<Self, D::Error> where D: Deserializer<'de> {
        Ok(HyperAD_ADFN::new_constant(0.0))
    }
}
